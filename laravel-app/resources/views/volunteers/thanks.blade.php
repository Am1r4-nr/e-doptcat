...
<div class="pt-28 pb-20 bg-cozy-bg min-h-screen flex items-center justify-center relative overflow-hidden">
    ...
    <div class="relative z-10 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="mb-8 relative">
            <div class="w-24 h-24 bg-cozy-warm/60 rounded-full flex items-center justify-center mx-auto relative z-10">
                <svg class="w-12 h-12 text-cozy-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24" stroke-width="2">
        ...
        <p class="font-script text-2xl text-cozy-accent mb-2">Welcome to the Team!</p>
        <h1 class="font-serif font-bold text-5xl text-cozy-brown mb-4">Application Received</h1>
        ...
        <p class="text-xl text-cozy-brown/60 mb-10 leading-relaxed font-sans">
            Thank you for signing up to volunteer with the <span class="font-bold text-cozy-brown">Abu Hurairah Club</span>!
            Your application has been submitted and our team will be in touch soon.
        </p>
        ...
        <div class="bg-cozy-card rounded-3xl shadow-xl p-8 border border-cozy-warm/40 mb-12 text-left">
            ...
            <div class="space-y-5">
                @foreach([
                    ['step' => '1', 'title' => 'Application Review', 'desc' => 'The AHC team will review your application within 5–7 business days.'],
                    ['step' => '2', 'title' => 'Interview / Screening', 'desc' => 'You may be invited for a short informal chat to learn more about your interests.'],
                    ['step' => '3', 'title' => 'Orientation Session', 'desc' => 'Attend a brief orientation to learn about our cats, protocols, and team culture.'],
                    ['step' => '4', 'title' => 'Start Volunteering!', 'desc' => 'Join a shift, meet the cats, and become part of the AHC family.'],
                ] as $item)

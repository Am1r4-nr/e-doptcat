                        ...
                        <div class="relative h-72 overflow-hidden bg-gradient-to-b from-teal-400 to-teal-500">
                            ...
                            @if($cat->ai_match_score > 0)
                                <div class="absolute top-4 left-4 group">
                                    <div class="bg-orange-500 text-white px-4 py-2 rounded-full text-sm font-bold flex items-center gap-2 shadow-lg hover:bg-orange-600 cursor-help transition-colors">

...
<!-- Page Header -->
<div class="mb-8">
    <h1 class="text-3xl font-cabinet font-semibold text-gray-800">Dashboard</h1>
...
<div class="grid grid-cols-4 gap-4 mb-8">
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-[#E8E2D8]">
        <p class="text-[10px] tracking-widest text-[#C9A84C] uppercase font-semibold mb-2">Total Cats</p>
        <p class="text-4xl font-bold text-gray-800">{{ $stats['total_cats'] ?? 0 }}</p>
        <p class="text-xs text-gray-400 mt-1">In the system</p>
    </div>
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-[#E8E2D8]">
        <p class="text-[10px] tracking-widest text-[#C9A84C] uppercase font-semibold mb-2">Adoptions</p>
        <p class="text-4xl font-bold text-gray-800">{{ $stats['adoptions_this_month'] ?? 0 }}</p>
        <p class="text-xs text-gray-400 mt-1">This month</p>
    </div>
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-[#E8E2D8]">
        <p class="text-[10px] tracking-widest text-[#C9A84C] uppercase font-semibold mb-2">Users</p>
    ...
    <div class="bg-[#C9A84C] rounded-2xl p-5 shadow-sm">
        <p class="text-[10px] tracking-widest text-[#E8D5A0] uppercase font-semibold mb-2">Donations</p>
...
<div class="grid grid-cols-3 gap-6">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-[#E8E2D8] flex flex-col">
        ...
        <a href="{{ route('admin.reports.index') }}" class="text-xs text-[#C9A84C] hover:text-[#C9A84C] font-semibold mt-5 tracking-wide uppercase">
            View All Reports →
        </a>
    </div>
</div>
...
<div class="grid grid-cols-3 gap-6 mt-6">
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-[#E8E2D8]">
        <div class="w-8 h-8 bg-[#FAF8F0] rounded-lg flex items-center justify-center mb-3">
        ...
        <a href="{{ route('admin.cats.index') }}" class="text-xs text-[#C9A84C] font-semibold mt-3 inline-block uppercase tracking-wide">View Directory →</a>
    </div>
    <div class="bg-white rounded-2xl p-5 shadow-sm border border-[#E8E2D8]">
        <div class="w-8 h-8 bg-[#FAF8F0] rounded-lg flex items-center justify-center mb-3">
    ...
    <div class="bg-amber-800 rounded-2xl p-5 shadow-sm">
        ...
        <a href="{{ route('admin.cats.index') }}" class="text-xs text-[#E8D5A0] font-semibold mt-3 inline-block uppercase tracking-wide">Review Now →</a>
    </div>
</div>

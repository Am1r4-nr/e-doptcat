...
<div class="max-w-6xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-7 bg-[#3D3D3D] rounded-2xl px-5 py-3 shadow-sm">
        <div class="flex items-center gap-3">
            ...
            <p class="text-xs tracking-widest text-[#C9A84C] uppercase font-semibold">Cats</p>
            <span class="text-sm text-[#555555]">·</span>
            <p class="text-sm font-semibold text-white">Register New Feline</p>
            <span class="text-sm text-[#555555]">·</span>
            <p class="text-xs text-[#9A9A9A]">Expand the e-Doptcat family. Fill in the details below to curate a new digital profile for our latest companion.</p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-5 gap-8">
            ...
            <form action="{{ route('admin.cats.store') }}" method="POST" enctype="multipart/form-data" id="catForm">
                ...
                <div class="bg-white rounded-2xl border border-[#E8E2D8] shadow-sm p-7 space-y-5">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <div>
                            <label class="flex items-center gap-1.5 text-xs font-semibold text-gray-500 mb-1.5">
                                <svg class="w-3.5 h-3.5 text-gray-400" fill="none" stroke="currentColor" stroke-width="1.75" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z"/></svg>
                                Name
                            </label>
                    ...
                    <div>
                        ...
                        <label for="image"
                            class="flex flex-col items-center justify-center gap-2 w-full h-36 bg-[#FAF6F0] border-2 border-dashed border-amber-200 rounded-xl cursor-pointer hover:border-amber-400 transition">
                            <svg class="w-10 h-10 text-amber-300" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M3 16.5v2.25A2.25 2.25 0 005.25 21h13.5A2.25 2.25 0 0021 18.75V16.5m-13.5-9L12 3m0 0l4.5 4.5M12 3v13.5"/></svg>
                            <p class="text-sm font-medium text-gray-500">Drag & drop your feline portrait here</p>
                            <p class="text-xs text-gray-400">High-resolution JPEG or PNG preferred</p>
        ...
        <div class="col-span-2 space-y-5">
            ...
            <div class="bg-gray-800 rounded-2xl overflow-hidden shadow-lg">
                <div class="relative h-52 bg-gray-700 flex items-center justify-center" id="previewImageContainer">

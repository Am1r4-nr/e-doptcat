    ...
    <div class="flex items-center justify-between mb-7">
        ...
        <div class="flex items-center gap-2">
            <a href="{{ route('admin.cats.edit', $cat) }}"
               class="p-2 rounded-xl text-[#C9A84C] hover:bg-white hover:shadow-sm border border-transparent hover:border-[#E8E2D8] transition" title="Edit">
            ...
            <form action="{{ route('admin.cats.destroy', $cat) }}" method="POST"
                ...
                @csrf @method('DELETE')
                <button type="submit"
                        class="p-2 rounded-xl text-red-400 hover:bg-white hover:shadow-sm border border-transparent hover:border-red-100 transition" title="Delete">

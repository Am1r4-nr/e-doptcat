...
<button @click="deleteIdx = i"
            ...
            <div class="bg-white rounded-2xl border border-[#E8E2D8] shadow-sm p-6"
                ...
                <!-- Done Confirmation -->
                <div x-show="confirmDone" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                     class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
                    <div @click.outside="confirmDone = null"
                        ...
                        <p class="font-jakarta text-lg font-extrabold text-[#1C1A17] mb-1.5">Mark as Done?</p>
                        <p class="text-sm text-[#A09890] mb-6 leading-relaxed" x-text="confirmDone"></p>
                        <div class="flex gap-3">
                            ...
                            <button @click="tick()"
                                    class="flex-1 px-4 py-2.5 text-sm font-semibold text-white bg-green-500 hover:bg-green-600 rounded-xl transition">
                                Mark Done
                            </button>
                        </div>
                    </div>
                ...
                <!-- Delete Confirmation -->
                <div x-show="confirmDelete" x-transition:enter="transition ease-out duration-150" x-transition:enter-start="opacity-0" x-transition:enter-end="opacity-100"
                     class="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
                    <div @click.outside="confirmDelete = null"
                        ...
                        <p class="font-jakarta text-lg font-extrabold text-[#1C1A17] mb-1.5">Remove Examination?</p>
                        <p class="text-sm text-[#A09890] mb-6 leading-relaxed" x-text="confirmDelete"></p>
                        <div class="flex gap-3">
                            ...
                            <button @click="remove(confirmDelete)"
                                    class="flex-1 px-4 py-2.5 text-sm font-semibold text-white bg-red-500 hover:bg-red-600 rounded-xl transition">
                                Remove
                            </button>
                        </div>
                    </div>

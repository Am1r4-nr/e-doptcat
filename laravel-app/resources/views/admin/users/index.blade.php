...
<div x-data="staffApp()" class="px-8 py-6 max-w-7xl mx-auto">
    ...
    <div x-show="activeTab === 'volunteers'" style="display:none">
        ...
        <div class="grid grid-cols-[1.5fr_1fr_1.5fr_1fr_1fr] gap-4 mb-3 px-8 text-[11px] font-bold text-gray-400 uppercase tracking-widest">
            <div>Volunteer</div>
            <div>Matric No.</div>
            <div>Program</div>
        ...
        <div class="space-y-3">
            <template x-for="v in volunteers.filter(v => v.status === 'APPROVED')" :key="v.id">
                <div class="bg-white rounded-full grid grid-cols-[1.5fr_1fr_1.5fr_1fr_1fr] items-center gap-4 px-6 py-4 shadow-[0_2px_15px_-5px_rgba(0,0,0,0.05)] border border-[#F0EBE3]">
                    <div class="min-w-0">
                    ...
                    <div class="text-[13px] font-semibold text-gray-600" x-text="v.matric"></div>
                    <div class="flex items-center gap-2 min-w-0">
                        ...
                        <span class="text-[13px] font-semibold text-gray-700 truncate" x-text="v.program"></span>
                    </div>
                    <div>
    ...
    <!-- ── BACKDROP ── -->
    <div x-show="showAddStaff || showEditStaff"
        ...
        volunteers: [
            {
                ...
                availability: 'Weekends', availTime: '9:00 AM – 5:00 PM',
                status: 'INTERVIEWING', statusClass: 'bg-[#FAF8F0] text-[#C9A84C] border border-[#E8E2D8]',
            ...
            },
            {
                ...
                availability: 'Flexible', availTime: '10:00 AM – 3:00 PM',
                status: 'PENDING', statusClass: 'bg-cyan-50 text-cyan-600 border border-cyan-100',
            ...
            },
            {
                ...
                availability: 'Weekdays', availTime: '8:00 AM – 12:00 PM',
                status: 'APPROVED', statusClass: 'bg-green-50 text-green-600 border border-green-100',
